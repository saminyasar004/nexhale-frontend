...
interface VapeHealthImpactProps {
	healthData: {
		riskTier: string;
...
const VapeHealthImpact = ({ healthData }: VapeHealthImpactProps) => {
		...
		>
			...
			<div className="grid grid-cols-2 gap-3 mb-6">
				<div className="bg-muted/50 rounded-xl p-4 text-center">
					...
					<p className="text-xs text-muted-foreground">Monthly CEI</p>
					<p className="font-display font-bold text-foreground">
						{healthData.ceiIntake}
					</p>
				</div>
				<div className="bg-muted/50 rounded-xl p-4 text-center">
...
export default VapeHealthImpact;
